    ...
    return (
        ...
        <div className="Header_container d-flex align-center justify-between">
            <div className=' logo_cont'>
                <img src={logo} alt="" className='pointer logo' onClick={() => { navigator("/products") }} />
            </div>

            <div className='d-flex g5  header_right_content'>

                <img className='icon' src={wishlist} onClick={() => { setFav(true) }} alt="" />
            ...
            {fav &&
                ...
                <div className="wishlist_Container" onClick={() => { setFav(false) }}>
            ...
            {cart &&
                ...
                <div className="wishlist_Container" onClick={() => { setCart(false) }}>
                    <Cart setCart={setCart} />
                </div>
            }
            {category &&

                <div className="wishlist_Container1" onClick={() => { setcategory(false) }}>
            ...
            {
                order &&
                <div className="wishlist_Container1" onClick={() => { setOrder(false) }}>
